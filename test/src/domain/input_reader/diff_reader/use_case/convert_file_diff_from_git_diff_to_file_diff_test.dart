...
void main() {
  ...
  group("When file1 content is mapped", () {
    ...
    test(
      "line 17 is `     commands:`",
      () => expect(result.lines.firstWhere((element) => element.lineNumber == 17).code, "     commands:"),
    );
    test(
      "line 55 is `    image: cirrusci/flutter:3.3.7`",
      () => expect(result.lines.firstWhere((element) => element.lineNumber == 55).code, "    image: cirrusci/flutter:3.3.7"),
    );
  });
  ...
  group("When file2 content is mapped", () {
    ...
    test(
      ...
      () => expect(result.lines.firstWhere((element) => element.lineNumber == 2).code, "import 'package:flutter_svg/flutter_svg.dart';"),
    );
  });
}
